...
var api = "https://api.geoapify.com/v2/places?";



async function fetchAirportGeo(POINT_NAME ) {


    return new Promise((resolve, reject) => {
        const url = `${api}categories=airport.international&filter=circle:${POINT_NAME},50000&bias=proximity:${POINT_NAME}&limit= 10&apiKey=${API_KEY}`;
...
module.exports = fetchAirportGeo;